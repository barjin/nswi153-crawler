        ...
        <>
            <div className="grid grid-cols-[auto_auto_auto_auto] justify-end items-end">
                ...
                <div className="col-span-1 m-2 px-2">
                    <input type="radio" id="url-sort" name="sort" value="url" defaultChecked={sortType === "url" ? true : false} onClick={() => setSortType("url")} />
                    <label className='ml-1'>URL</label>
                </div>
                <div className="col-span-1 m-2 px-2">
                    <input type="radio" id="last-crawl-sort" name="sort" value="last-crawl" defaultChecked={sortType === "lastCrawl" ? true : false} onClick={() => setSortType("lastCrawl")} />
